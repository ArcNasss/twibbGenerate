    ...
    <div className="flex flex-col gap-4 bg-white p-4 rounded-md">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              className="bg-yellow-500 !w-[10rem] md:!w-[15rem]"
            />
            <Button
              variant={"primary"}
              onClick={() => setScale((prev) => prev + 0.01)}
      ...
      <div className="flex space-x-4 items-center mx-auto">
        <div>
          ...
          <label
            htmlFor="foto"
            className="flex items-center gap-2 truncate max-w-[18rem] md:max-w-sm py-1 px-4 lg:py-2 rounded-full border-0 lg:text-lg text-md font-semibold bg-yellow-200 text-yellow-600 h-10 hover:bg-yellow-300 cursor-pointer duration-100"
          >
        ...
        <Button
          onClick={() => {
            ...
            if (data) {
              downloadURI(
                data,
                `Twibbon ${searchParams?.title ?? "PPTA 2024"}.jpg`
              );
            }
          }}
          variant={"primary"}
